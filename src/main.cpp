...
const int POS_BLOCK_REWARD_FIX = 1850;
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindex, int64_t nCoinAge, int64_t nFees)
{
    ...
    if(pindex->nHeight < POS_BLOCK_REWARD_FIX)
	{
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "LunarCoin - 2015!";
        CTransaction txNew;
        txNew.nTime = 1422642003;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1422642003;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1604272;
		if(fTestNet)
        {
            block.nNonce   = 0;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xde6ab8d87ddd94af548c727eecfa8186b2b020f3f75f63f4e894aaf3350846b7"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xc1, 0xf0, 0xa2, 0x33 };
