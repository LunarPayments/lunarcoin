...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "LunarCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"188.166.59.134", "188.166.59.134"}, //Main LunarCoin Seed Node
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("LunarCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("LunarCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("LunarCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("LunarCoin-msghand");
