...
private slots:
    ...
    void on_BuyLNR_clicked();
    void on_SellLNRBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputLNR_textChanged(const QString &arg1);
    ...
    QString BuyLNR(QString OrderType, double Quantity, double Rate);
    QString SellLNR(QString OrderType, double Quantity, double Rate);
